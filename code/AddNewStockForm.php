...
<body>
    <main class="main_form_container">
        ...
        <form action="AddNewStock.php" method="post" id="form" class="form">

            <!-- Description -->
             <div class="inputMain">
            <label for="Description">Description: </label>
            <input type="text" id="Description" placeholder="Enter a description of the new stock item" name="Description" required>
            </div>
