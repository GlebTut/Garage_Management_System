...
try {
    ...
    $insert = $con->prepare("INSERT INTO `Stock_Item`(`Description`, `Stock_Quantity`, `Reorder_Quantity`, `Cost_Price`, `Retail_Price`) 
    ...
    $insert->bindParam(':Retail_Price', $Retail_Price);
